...
import { sortCoreBioMetrics } from './coreBioMetrics';
 ...
 */
export function MemberAthleteCoreStatsGrid({ stats, loading }) {
  const rows = useMemo(() => sortCoreBioMetrics(stats), [stats]);
