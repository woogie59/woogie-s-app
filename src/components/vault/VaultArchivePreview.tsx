...
const VaultArchivePreview: React.FC<VaultArchivePreviewProps> = ({ onClose }) => {
  return (
    <div
      className="fixed inset-0 z-[100] w-full h-full min-h-[100dvh] bg-[#0a0a0a] overflow-hidden text-white antialiased animate-in fade-in zoom-in-95 duration-500 ease-out"
      role="dialog"
      aria-modal="true"
    ...
    >
      ...
      <div className="flex min-h-[100dvh] w-full flex-col bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-900 via-[#0a0a0a] to-black pb-safe">
        <div className="flex min-h-0 flex-1 w-full items-center justify-center px-4 pt-[max(3.25rem,calc(env(safe-area-inset-top)+2.5rem))] pb-10">
